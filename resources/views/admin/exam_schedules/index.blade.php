...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div>
        <h1 class="page-title">جدول الامتحانات</h1>
        <p class="page-sub">صورة جدول الامتحانات لكل صف</p>
    </div>
    <a href="{{ route('admin.exam-schedules.create') }}" class="btn-primary-sm">
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ asset('assets/uploads/exam-schedules/' . $schedule->image) }}"
                                 alt="exam schedule"
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('admin.exam-schedules.edit', $schedule->id) }}" class="btn-outline-sm">
