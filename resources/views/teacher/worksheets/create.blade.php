...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-3">
    <div><h1 class="page-title">{{ __('messages.add_worksheet') }}</h1></div>
    <a href="{{ route('teacher.worksheets.index') }}" class="btn-outline-sm">
...
<form action="{{ route('teacher.worksheets.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row g-3">
                ...
                <div class="panel-card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" name="year" class="form-control" value="{{ old('year') }}" min="1900" max="2100">
                        </div>
                        <div class="col-6">
